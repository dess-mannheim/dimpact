...
try:
    ...
    rtd = None
import torch
from stability.measures.repsim.utils import align_spatial_dimensions
from stability.measures.repsim.utils import flatten
...
def representation_topology_divergence(
    ...
    return rtd(R, Rp, pdist_device, trials=trials, batch=batch)
